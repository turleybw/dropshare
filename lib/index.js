(function () {
  ...
  function create(options) {
    ...
    function modifiedBodyParser(req, res, next) {
      var multi = connect.bodyParser.parse['application/x-www-form-urlencoded'];
      connect.bodyParser.parse['application/x-www-form-urlencoded'] = undefined;
      bP(req, res, function () {
        connect.bodyParser.parse['application/x-www-form-urlencoded'] = multi;
        next();
      });
    }
